...
{
    public class AgfMembershipProvider: MembershipProvider
    {

        private UserRepository _userRepsitory;

        public AgfMembershipProvider()
        {
        ...
        public override bool ValidateUser(string username, string password)
        {
            ...
            int count = _userRepsitory.GetALL().Where(x => x.email == username && x.password == password).Count();
            if (count != 0)
                return true;
            else
                return false;
